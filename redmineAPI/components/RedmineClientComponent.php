...
class RedmineClientComponent extends Component
{
    ...
    public function getIssuesByProjectId($project_id)
    {
        return $this->client->issue->all(['project_id' => $project_id]);
    }
    ...
    public function getTimeEntries($options = ["project_id" => null, "spent_on" => null])
    {
